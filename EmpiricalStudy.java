...
public class EmpiricalStudy
{
	public static void main(String []args)
	{
		...
		System.out.println("Quicksort: computed in ");

		if(elapsedTime >= 60)
			System.out.printf("%d minutes and ", elapsedTime / 60);

		System.out.printf("%d seconds\n", elapsedTime % 60);

		System.out.printf("\nStarting selection sort test:\n");
		...
		System.out.println("Selectionsort: computed in ");
		...
		System.out.println("Bubblesort: computed in ");
